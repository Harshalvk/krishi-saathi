...
Krishi Saathi is an AI Agri-Tech IoT device which helps farmers to monitor their farm, land & crops effectively. This repository contains backend of the application.
